  ...
  return [
    componentRoute(
      ...
      } satisfies ComponentRouteNav,
      {
        ...
        componentRoute(
      "/dataaaa",
      { label: "Dataaaa", title: "Dataaaa", showInNav: false, navIconFa: "fa-solid fa-cube" },
      { selector: "app-dataaaa", load: () => import("./dataaaa/ui/app.dataaaa.view.js") },
    ),
    pageRoute(
      "/catalogo",
      {
        ...
        navChildren: [
          { path: "/dataaaa", label: "Ítems", navIconFa: "fa-solid fa-list" },
          {
