...
import { template } from "./app.doc.cli.view.html";
import docMarkdownBase from "../shared/doc-guide.view.css?inline";
import viewStyles from "./app.doc.cli.view.css?inline";
...
export class AppDocCliElement extends AbeyComponentElement {}
