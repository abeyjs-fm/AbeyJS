...
import { template } from "./app.doc.tables.view.html";
import docMarkdownBase from "../shared/doc-guide.view.css?inline";
import viewStyles from "./app.doc.tables.view.css?inline";
...
export class AppDocTablesElement extends AbeyComponentElement {}
